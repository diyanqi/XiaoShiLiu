<template>
  <div class="api-docs">
    <div class="docs-header">
      <h2>知识星球图文社区 API 接口文档</h2>
      <div class="docs-info">
        <span class="version">版本: v1.3.1</span>
        <span class="base-url">基础URL: http://localhost:3001/</span>
        <span class="update-time">更新时间: 2026-2-14</span>
      </div>
    </div>
    ...
    apis: [
      {
        ...
        expanded: false,
        params: [
          { name: 'user_id', type: 'string', required: true, description: '知识星球号（3-15位，字母数字下划线）' },
  ...
  "data": {
    ...
    "tokens": {
      ...
      },
      {
        ...
        expanded: false,
        params: [
          { name: 'user_display_id', type: 'string', required: true, description: '知识星球号' },
  ...
  },
  {
    ...
    apis: [
      ...
      },
      {
        ...
        title: '搜索用户',
        description: '根据关键词搜索用户（昵称或知识星球号）',
        expanded: false,
        params: [
      ...
      },
      {
        ...
        path: '/api/users/:id',
        title: '获取用户详情',
        description: '根据知识星球号获取用户详细信息',
        expanded: false,
        params: [
          { name: 'id', type: 'string', required: true, description: '知识星球号' }
        ]
      },
      {
        method: 'GET',
      ...
      },
      {
        ...
        expanded: false,
        params: [
          { name: 'id', type: 'string', required: true, description: '被关注用户的知识星球号' }
        ]
      },
      {
        method: 'DELETE',
        ...
        expanded: false,
        params: [
          { name: 'id', type: 'string', required: true, description: '被取消关注用户的知识星球号' }
        ]
      },
      {
        method: 'GET',
        ...
        expanded: false,
        params: [
          { name: 'id', type: 'string', required: true, description: '目标用户的知识星球号' }
        ]
      },
      {
        method: 'GET',
    ...
    apis: [
      {
        ...
        expanded: false,
        params: [
          { name: 'keyword', type: 'string', required: false, description: '搜索关键词（支持搜索知识星球号、昵称、标题、正文内容、标签名称）' },
    ...
    "username": "admin"
      ...
      },
      {
        ...
        params: [
          ...
          { name: 'user_display_id', type: 'string', required: false, description: '按知识星球号筛选' },
      ...
      },
      {
        ...
        expanded: false,
        params: [
          { name: 'user_id', type: 'string', required: true, description: '知识星球号' },
      ...
      },
      {
        ...
        params: [
          ...
          { name: 'user_display_id', type: 'string', required: false, description: '按作者知识星球号筛选' },
      ...
      },
      {
        ...
        params: [
          ...
          { name: 'user_display_id', type: 'string', required: true, description: '发布用户知识星球号' }
        ]
      },
      {
        method: 'PUT',
      ...
      },
      {
        ...
        params: [
          ...
          { name: 'user_display_id', type: 'string', required: false, description: '按评论者知识星球号筛选' },
      ...
      },
      {
        ...
        params: [
          ...
          { name: 'user_display_id', type: 'string', required: false, description: '用户知识星球号搜索' },
      ...
      },
      {
        ...
        params: [
          ...
          { name: 'user_display_id', type: 'string', required: false, description: '按用户知识星球号筛选' },
      ...
      },
      {
        ...
        expanded: false,
        params: [
          { name: 'user_display_id', type: 'string', required: true, description: '用户知识星球号' },
          { name: 'target_type', type: 'int', required: true, description: '目标类型（1-笔记, 2-评论）' },
          { name: 'target_id', type: 'int', required: true, description: '目标ID' }
        ]
      },
      ...
      },
      {
        ...
        params: [
          ...
          { name: 'user_display_id', type: 'string', required: false, description: '按接收用户知识星球号筛选' },
      ...
      },
      {
        ...
        expanded: false,
        params: [
          { name: 'user_display_id', type: 'string', required: true, description: '接收用户知识星球号' },
