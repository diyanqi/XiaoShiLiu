...
const columns = [
  ...
  { key: 'user_id', label: '知识星球号', type: 'user-link', sortable: false, maxLength: 15 },
...
const formFields = [
  { key: 'user_id', label: '知识星球号', type: 'text', required: true, placeholder: '请输入知识星球号', maxlength: 15 },
...
const searchFields = [
  { key: 'user_id', label: '知识星球号', placeholder: '搜索知识星球号' },
